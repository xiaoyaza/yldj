...
public interface BasicPayService {
     ...
     * @return 是否成功
     */
    RefundRecord refundTrading(Long tradingOrderNo, Long refundNo,BigDecimal refundAmount) throws CommonException;
...
//    ExecutionResultResDTO refundTradingByTradingOrderNo(Long tradingOrderNo, BigDecimal refundAmount) throws CommonException;
     ...
     * @param refundNo 退款单号
     */
    void syncRefundResult(Long refundNo) throws CommonException;
