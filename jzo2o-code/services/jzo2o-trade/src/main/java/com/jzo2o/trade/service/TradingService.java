...
public interface TradingService extends IService<Trading> {
     ...
     * @return 交易单
     */
    Trading queryDuringTrading(String productAppId,String productOrderNo, String tradingChannel);
     ...
     * @return 交易单
     */
    List<Trading> queryByProductOrder(String productAppId,String productOrderNo);
     ...
     * @return 交易单
     */
    Trading findFinishedTrading(String productAppId,String productOrderNo);
}
