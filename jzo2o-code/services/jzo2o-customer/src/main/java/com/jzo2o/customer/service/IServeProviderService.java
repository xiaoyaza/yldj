...
public interface IServeProviderService extends IService<ServeProvider> {
     ...
     */
    void registerServeProvider(InstitutionRegisterReqDTO institutionRegisterReqDTO);

    /**
     * 机构重置密码
     * @param institutionRegisterReqDTO
     */
    void registerPassword(InstitutionResetPasswordReqDTO institutionResetPasswordReqDTO);
}
